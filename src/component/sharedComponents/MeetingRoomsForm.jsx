...
const MeetingRoomsForm = ({ setShow }) => {
          ...
          <div className="relative flex flex-col items-center justify-start w-full max-w-4xl py-8 bg-white rounded-lg max-h-[90vh] overflow-y-auto">
            ...
            {currentStep === 1 && (
              <div className="w-full px-8">
                <h1 className="mb-8 text-3xl font-bold text-center text-transparent lg:text-4xl bg-custom-blue bg-clip-text">
                  Let Us Set Up Your Meeting Rooms Today
                </h1>
                ...
                <div className="grid grid-cols-1 gap-6 mb-6 md:grid-cols-2">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 border border-custom-blue rounded-lg bg-white"
                    />
                  </div>
                  <div>
                    <label className="block mb-2 text-sm font-bold text-gray-700 lg:text-lg">
            ...
            {currentStep === 2 && (
              <div className="w-full px-8 text-center">
                <div className="mb-6">
                  ...
                  <h2 className="mb-8 text-3xl font-bold text-center text-transparent lg:text-4xl bg-custom-blue bg-clip-text">
                    Success!
                  </h2>
